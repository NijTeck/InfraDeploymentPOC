...
// - None
// [Change Log]
// - 2025-02-11: Renamed ruleResolveConfiguration with resolveConfiguration
//               Renamed param ruleResolvedConfiguration with param ruleResolveConfiguration
//               Disabled param resolveConfiguration
//               Disabled param enableTelemetry (Azure Verified Module)
//               Disabled resource avmTelemetry (Azure Verified Module)
// - 2025-02-06: Initial commit
//               Based on 'br/public:avm/res/insights/scheduled-query-rule:0.3.0'
//               Modified actions to support customProperties
// ---------------------------------------------------------------------------------------------------------
